...
Ruta = 'C:/Users/OneScreen/Documents/Taller Automatizacion'
...
with open("C:/Users/OneScreen/Documents/Taller Automatizacion/Usuarios.csv.csv","r") as archivo:
...
import csv
with open("C:/Users/OneScreen/Documents/Taller Automatizacion/Usuarios.csv.csv") as file:
    reader = list(file)
    for row in reader:
        print (row)
...
df = pd.read_csv ('C:/Users/OneScreen/Documents/Taller Automatizacion/Usuarios.csv.csv', usecols=fields, sep=';')
print (df)


df = pd.read_csv (r"C:/Users/OneScreen/Documents/Taller Automatizacion/Usuarios.csv.csv")
